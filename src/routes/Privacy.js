  ...
  render() {
    return (
      <PrivacyDiv>
        ...
        <p>
          No block no party limited ("us", "we", or "our") operates the
          kickback.events website (the "Service").
        </p>
        ...
        <p>
          ...
          our Terms and Conditions, accessible from kickback.events
        </p>
        ...
        <p>
          No block no party limited uses the collected data for various
          purposes:
        </p>
        <ul>
        ...
        <p>
          No block no party limited will take all steps reasonably necessary to
        ...
        <p>
          No block no party limited may disclose your Personal Data in the good
          faith belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of No block no party
            limited
          </li>
          <li>
