...
const { version: pkgVersion } = require(path.join(projectDir, 'node_modules', '@noblocknoparty/contracts', 'package.json'))
...
fs.writeFileSync(path.join(projectDir, 'src', 'config', 'env.json'), JSON.stringify(config, null, 2))
